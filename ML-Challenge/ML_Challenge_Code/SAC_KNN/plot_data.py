...
########################################
# 
pf_file  = h5py.File('./High_Mob_result.hdf5', 'r')
...
# ########################################
# 
# rr_file  = h5py.File('./High_Mob_result.hdf5', 'r')
...
sac_file  = h5py.File('./High_Mob_result.hdf5', 'r')
...
sac_mod_file  = h5py.File('./High_Mob_result.hdf5', 'r')
...
sac_ug_file  = h5py.File('./High_Mob_result.hdf5', 'r')
...
plt.title('Fairness (JFI) for only SAC',fontsize=20)
plt.xlabel('TTI',fontsize=18)
plt.ylabel('JFI',fontsize=18)
#plt.legend(["SAC_KNN w/o Mod","SAC_KNN w/ Mod","SAC_KNN w/ UG+Mod","PF","RR"], loc = "lower right",fontsize=15)
plt.legend(["SAC_KNN w/o Mod","SAC_KNN w/ Mod","SAC_KNN w/ UG+Mod"], loc = "lower right",fontsize=15)
plt.show()
